...
## [2026.8.20] - 2026-08-19

### Добавлено

- Claude отделяет уведомление об обновлении от основного результата и выводит новые возможности маркированным списком.

## [2026.8.19] - 2026-08-19

### Добавлено

- Claude однократно показывает оформленную сводку изменений после установки новой версии плагина.

## [2026.8.18] - 2026-08-19

### Добавлено

- Claude показывает обновлённый блок с перечнем новых возможностей при первом вызове инструмента e-Comet после обновления плагина.

## [2026.8.17] - 2026-08-19

### Добавлено

- Уведомление об обновлении одинаково оформляется в Codex и Claude перед основным ответом агента.

## [2026.8.16] - 2026-08-19

### Добавлено

- Уведомление после обновления отображается отдельным блоком с заголовком, списком новых возможностей и разделителем перед основным ответом.
