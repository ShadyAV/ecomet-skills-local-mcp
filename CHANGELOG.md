...
- Тестовая проверка уведомляет о доступной версии после истечения двухминутного интервала.

## [2026.8.27] - 2026-08-20

### Добавлено

- Проверка доступной версии временно выполняется каждые две минуты для тестирования уведомлений.

## [2026.8.26] - 2026-08-20

### Добавлено

- Одноразовая сводка обновления сохраняет форматирование и показывается в начале итогового ответа агента.

## [2026.8.25] - 2026-08-20

### Добавлено

- Уведомление о версии показывается ровно один раз в ближайшем итоговом ответе даже при нескольких вызовах инструментов.
