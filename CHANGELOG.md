...
## [2026.8.28] - 2026-08-27

### Добавлено

- `ozon_seller_promotion_report` — подписанная выгрузка отчёта по аналитике продвижения из Ozon Seller за выбранный
  период в один проверенный XLSX-файл.

### Критические изменения

- В ChatGPT Desktop (Codex) подписанные локальные инструменты теперь требуют доверенных хуков плагина. Установки,
  которые не запускают или не доверяют этим хукам, не поддерживаются.
