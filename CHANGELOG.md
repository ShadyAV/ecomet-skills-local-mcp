...
## [2026.8.23] - 2026-08-20

### Добавлено

- После очередного обновления агент показывает новую сводку изменений только один раз для текущей версии плагина.

## [2026.8.22] - 2026-08-20

### Добавлено

- Уведомление о новой версии стабильно появляется перед первым результатом e-Comet после обновления плагина.

## [2026.8.21] - 2026-08-20

### Добавлено

- Уведомления об обновлении корректно работают при запуске плагина через символические ссылки и хранят состояние отдельно для каждого приложения.
